...
PAPER_FIGURES: tuple[PaperFigure, ...] = (
    PaperFigure(
        ...
        source_relpath="figures/rousseau2023_monsoon_predictive_hazard_history_resolution/fig01_adjusted_inputs_and_fitted_hazards.pdf",
        tex_file="main.tex",
    ...
    PaperFigure(
        ...
        source_relpath="figures/rousseau2023_monsoon_orbital_phase_rayleigh/fig03a_rayleigh_phase_polar_precession.pdf",
        tex_file="main.tex",
    ...
    PaperFigure(
        ...
        source_relpath="figures/rousseau2023_monsoon_predictive_hazard_history_resolution/fig02_adjusted_model_comparison_delta_aicc.pdf",
        tex_file="main.tex",
    ...
    PaperFigure(
        ...
        source_relpath="figures/rousseau2023_monsoon_orbital_phase_rayleigh/fig03b_rayleigh_phase_polar_obliquity.pdf",
        tex_file="SI.tex",
    ...
    PaperFigure(
        ...
        source_relpath="figures/rousseau2023_monsoon_orbital_phase_rayleigh/fig04_phase_ecdf_uniform_check.pdf",
        tex_file="SI.tex",
    ...
    PaperFigure(
        ...
        source_relpath="figures/rousseau2023_monsoon_bin_hazard_phase_poisson/fig03_fitted_hazards_from_fig01de.pdf",
        tex_file="SI.tex",
    ...
    PaperFigure(
        ...
        source_relpath="figures/rousseau2023_monsoon_bin_hazard_phase_poisson_sensitivity/fig07_extended_baseline_predictor_correlation.pdf",
        tex_file="SI.tex",
    ...
    PaperFigure(
        ...
        source_relpath="figures/rousseau2023_monsoon_bin_hazard_phase_poisson_sensitivity/fig06_sensitivity_aicc_and_likelihood_tests.pdf",
        tex_file="SI.tex",
    ...
    PaperFigure(
        ...
        source_relpath="figures/rousseau2023_monsoon_bin_hazard_phase_poisson_sensitivity/fig04_base_vs_extended_hazards.pdf",
        tex_file="SI.tex",
    ...
    PaperFigure(
        ...
        source_relpath="figures/rousseau2023_composite_age_uncertainty_sensitivity/fig09_age_offsets_and_significance_fraction.pdf",
        tex_file="SI.tex",
