...
This script is deliberately separate from ``Predictive_hazard_history_resolution.py``.
...
RUN_NAME = "rousseau2023_monsoon_predictive_hazard_bootstrap_diagnostics"
