...
The main analysis used a history-conditioned binned Poisson predictive-information framework. The 0--640 ka interval was divided into bins of width \(\Delta t=0.2\) kyr. For bin \(i\), the response was the observed event count \(Y_i\), modeled conditionally on the older event history and external covariates as
\[
